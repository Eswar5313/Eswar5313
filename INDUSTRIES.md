...
<img src="https://img.shields.io/badge/🏢_Industries-ffffff?style=for-the-badge&labelColor=C9A227" />
...
---
## 🏢 Industries worked in — employment record (ATS chronology)

| Industry | Employer | Role | Period | Numbers |
|---|---|---|---|---|
| **IT Services / Data Analytics** | HEXA Solutions, Ghaziabad | Data Analyst (Intern → certificate) | Jun – Aug 2026 | 13 projects, org code FYIXYK |
| **Automotive — used-car marketplace** | Spinny | Closure Manager | Jun 2025 – Mar 2026 | 250+ deals, +18 % closure rate, −14 % closure time, 4.8/5 CSAT, Top Closure Consultant Q2 |
| **Automotive — classifieds & retail** | OLX Autos | Sr Customer Service Advisor & Team Lead | Dec 2021 – Feb 2022 | 87 % FCR |
| **Luxury Real Estate — UAE** | Square Yards, Dubai | Associate Portfolio Manager | Sep – Nov 2021 | 100+ HNI accounts, 15+ nationalities, 90 %+ retention |
| **Automotive — used-car marketplace** | Spinny | Sales Analyst | Feb – May 2021 | Pipeline & conversion analytics |
| **Fintech — lending marketplace** | Paisabazaar | Sales Consultant | Oct 2019 – Jun 2020 | 28 % conversion, ₹1.5 Cr+ monthly disbursals |
| **Logistics & 3PL** | Globus Logisys | Management Trainee | May – Dec 2017 | −30 % stockouts, −22 % cycle delay |
| **Digital Marketing / EdTech** | Tidalwave Solutions / Digiperform | Digital Marketing | 2016 – 17 | Campaign execution |

**Cumulative:** ₹13.5 Cr+ sales facilitated · 8+ years · 5 industries · India + UAE

## 🧪 Industries added through 2026 programmes
...
| Multi-domain engineering & business | Internship Studio (12 domains) | 16 project packs |
| Travel | Fora Travel · Dreamport | Advisor certification, earnings analysis |

## 🔁 What transfers between industries

| From | To | Transferred capability |
|---|---|---|
| Logistics floor | Analytics | Knowing which KPI actually moves cost (stockouts, cycle time, fill rate) |
| Fintech sales | Product | Conversion funnels, objection patterns → JTBD and blockers |
| Dubai HNI portfolio | Any client-facing senior role | Multicultural stakeholder management, retention discipline |
| Used-car closure | Ops management | Documentation rigour, cross-team coordination under deadline |

## ✅ Fitment Snapshot — Industries

| What the best roles ask for | What I bring | Proof |
|---|---|---|
| Stable, explainable career story | One locked chronology (ATS/UAN-consistent), short stints grouped thematically, 2022–25 declared as reskilling | [Experience](./EXPERIENCE.md) |
| Industry breadth without shallowness | Every industry line has a measured number attached | [Impact](./IMPACT.md) |
