...
<details open>
<summary>🚚 <b>Supply Chain, Operations & Quality</b></summary>
<br>
...
| 📘 **SC Foundations: Project Management** | LinkedIn Learning | Jun 2026 |
| 📘 **SC & Ops Careers: Certification Tips** | LinkedIn Learning | Jun 2026 |

</details>

<details open>
<summary>📊 <b>Data Analytics, BI & Project Management</b></summary>
<br>
...
| 🏆 **Google Project Management** | Google | Agile + waterfall |
| 📈 **PG in Data Analytics** | Entri Elevate | *In progress* (Aug 2026 – Feb 2027) |
...
<details open>
<summary>💼 <b>Sales, CRM & Enterprise Systems</b></summary>
<br>

| Credential | Issuer | Detail |
|---|---|---|
| 🏆 **Salesforce Administrator** | Salesforce | CRM config & automation |
| 🛒 **Pep Sales Star Micro-Internship** | PepsiCo × Internshala | Oct 2025 |
| ⚙️ **SAP MM — Logistics/SCM** | Entri Elevate | *In progress* |
...
|---|---|
| 🛒 **E-commerce / Quick Commerce** | Flipkart SCOA · CSCMP · Google DA · Six Sigma |
| 🍫 **FMCG** | PepsiCo (Sales + SC) · CSCMP · Six Sigma |
...
## 🎯 View 3 — Role Fitment Map

| Target Role | Supporting Credential Stack |
|---|---|
| 📊 **Sr Manager — Data Analytics** | Google DA + BI · Entri PG · Anthropic AI Fluency · 13-project proof |
