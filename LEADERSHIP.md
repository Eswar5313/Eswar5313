...
![Header](https://capsule-render.vercel.app/api?type=waving&color=0:0B0F1A,35:1E1B4B,70:7C3AED,100:22D3EE&height=190&section=header&text=Leadership&fontSize=46&fontColor=ffffff&fontAlignY=38&animation=twinkling&stroke=22D3EE&strokeWidth=1&desc=Team%2C%20ownership%20and%20decision%20evidence&descSize=16&descAlignY=62&descColor=22D3EE)
...
## 🧑‍✈️ Leadership evidence

| Dimension | Evidence | Scale |
|---|---|---|
| **People leadership** | Team Lead, OLX Autos service desk — coaching, queue and escalation ownership | Team · 87 % FCR |
...
## 🪜 Skills → leadership mapping

| Technical skill | Leadership behaviour it enables |
|---|---|
| Dashboard building | Running a team on visible numbers instead of opinions |
| Six Sigma Black Belt | Structured problem-solving reviews (DMAIC) with the team |
| PRD / rollout design | Setting kill criteria and gates before launch |
| Verified-figures discipline | Credibility with finance and leadership |
| AI-partnered delivery | Multiplying team output while keeping disclosure standards |

## 🎯 Leadership roles I am ready for
Analytics team lead (3–8 analysts) · Operations / warehouse manager · Customer success manager · Product analyst lead · Senior Manager / AVP (Analytics · SCM · Ops) with 6–12 months of in-role ramp.

## ✅ Fitment Snapshot — Leadership
