...
<img src="https://img.shields.io/badge/🏭_Sectors-ffffff?style=for-the-badge&labelColor=C9A227" />
...
---
## 🏭 Sector exposure (projects + roles)

| Sector | Through roles | Through projects | Signature number |
|---|---|---|---|
| **Logistics & Supply Chain** | Globus Logisys | FedEx EDA · 2,000-SKU dark-store study · RoaDo FreightOS assessment | −30 % stockouts, −22 % cycle delay |
| **E-commerce & Quick-commerce** | — | Flipkart CSAT · Amazon Prime · Zepto AOV · Blinkit strategy · Nykaa UX · CartShare · grocery STP sprint | CSAT 4.48 → 3.66 |
| **Automotive & Used Cars** | Spinny (×2) · OLX Autos | Tata Motors role targeting | 250+ deals · 87 % FCR |
| **Electric Vehicles & Energy** | Codec Technologies | India EV dashboard · 10 EV projects · textile energy audit · solar charging | EKF SOC RMSE 0.63 % · ₹81.9 L savings |
| **Fintech & Financial Services** | Paisabazaar · InvestMyFunds assignment | NSE SQL · Aurora Foods ratios · financial ledger | 28 % conversion · ₹1.5 Cr+/month |
| **Real Estate (India & Dubai)** | Square Yards Dubai | Dubai house-price model · Airbnb dashboard | 99 AED/sqft · 90 %+ retention |
...
| **Manufacturing & Industrial IoT** | — | Predictive maintenance · textile mill energy | 23–24 h early warning |
| **Construction & Infrastructure** | — | RCC IS 456 · AutoCAD civil · EV-priority traffic signal | 1,230-entity DXF |
| **Education & EdTech** | — | Student performance ML · exam proctoring · library system | R² 0.8805 |
| **HR & Corporate Services** | — | HR policy manual · TechX wellbeing | ₹5,714/employee engagement budget |
| **Retail & Consumer Brands** | — | Multi-Region Sales Dashboard · EcoStyle campaign | ₹14.26 Cr modelled · ROAS 4.53× |
| **Digital Marketing** | Tidalwave / Digiperform · Imagine.bo | EcoStyle · LinkedIn playbook | — |
| **Travel** | Fora Travel · Dreamport (advisor, 2026) | Earning-potential analysis | — |

## 🌐 Geographic exposure
India (NCR, Chennai, Hyderabad, Mumbai) · UAE (Dubai — HNI clients of 15+ nationalities) · Target: Germany (Blue Card) · Gulf

## ✅ Fitment Snapshot — Sectors
