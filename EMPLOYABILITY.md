...
<img src="https://img.shields.io/badge/✅_Employability-ffffff?style=for-the-badge&labelColor=C9A227" />
...
---
## ✅ Employability scorecard — requirement → evidence

Each row is a requirement that appears in most JDs for the role. ✔ = met with linked evidence. ◐ = partially met, in progress.
...
| Domain knowledge | ✔ | 8+ yrs ops / sales / CX |
| Stakeholder management | ✔ | President-level presentations |
| Team leadership (for Manager) | ✔ | OLX Team Lead; 2026 programme management |
| **Score** | **9 / 9** | |

### Supply Chain / Operations Manager (Sr Manager – AVP)
| Requirement | Status | Evidence |
|---|:-:|---|
| Inventory, replenishment, stockout control | ✔ | Globus −30 % stockouts |
| Process improvement (Lean / Six Sigma) | ✔ | Six Sigma Black Belt · −22 % cycle delay |
| SCM credential | ✔ | CSCMP SCPro · IIM-A SC Digitization · PGDLSCM |
| Analytics for ops | ✔ | 2,000-SKU study · FedEx EDA |
| ERP (SAP MM) | ◐ | Entri Elevate SAP MM in progress |
| Vendor / 3PL management | ✔ | Globus Logisys |
| People management | ✔ | OLX Team Lead |
| **Score** | **6.5 / 7** | |

### Product Manager / APM (AI-first)
| Requirement | Status | Evidence |
|---|:-:|---|
...
### Customer Success / Key Account / Sales Manager
| Requirement | Status | Evidence |
|---|:-:|---|
| Retention & account growth | ✔ | 90 %+ HNI retention |
| Conversion & pipeline | ✔ | 28 % conversion · ₹13.5 Cr+ |
| CRM proficiency | ✔ | Salesforce Administrator |
| Service metrics | ✔ | 87 % FCR · 4.8/5 CSAT |
| Team leadership | ✔ | OLX Team Lead |
| **Score** | **5 / 5** | |

## 🧮 Overall
| Role family | Score | Readiness |
|---|:-:|---|
| Senior Data Analyst / Analytics Manager | 100 % | Immediate |
| Customer Success / Sales Manager | 100 % | Immediate |
| Supply Chain / Operations Manager | 93 % | Immediate (SAP MM closing) |
...
## ✅ Fitment Snapshot — Employability
