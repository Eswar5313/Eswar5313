...
<img src="https://img.shields.io/badge/📚_Learning-ffffff?style=for-the-badge&labelColor=C9A227" />
...
---
## 📚 Live learning programmes (2026)

| Programme | Provider | Window | Adds |
|---|---|---|---|
| AI-First Product Management | Airtribe | Jun 2026 – Jan 2027 | PM craft with AI; 8 case studies delivered so far |
| PG in Data Analytics | Entri Elevate | Aug 2026 – Feb 2027 | Power BI/DAX depth, SQL, Python |
| SAP MM — Logistics / SCM | Entri Elevate | Jul 2026 – | ERP procurement & inventory |
...
IIM Ahmedabad Supply Chain Digitization · CSCMP SCPro · Six Sigma Black Belt · PGDLSCM · Google Data Analytics · Google Business Intelligence · Google Project Management · Google (4th specialization) · Salesforce Administrator · Unilever · LVMH · PepsiCo SC Stars & Sales Star · Anthropic AI Fluency ×2 · Claude 101 · Agent Skills

## 📖 Learning pattern
Learn → build a project → document the method → publish. Every programme above has at least one folder in the master repository.

## ✅ Fitment Snapshot — Learning
